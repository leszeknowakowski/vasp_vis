...
class MyMainWindow(MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        with open(os.path.expanduser('~/python/inputs/elementColorSchemes.json'), 'r') as file:
        ...
        self.end_geometry_button.setIcon(QtGui.QIcon(os.path.expanduser('~/python/inputs/end.png')))
        self.end_geometry_button.setFixedWidth(30)
        self.start_geometry_button = QtWidgets.QPushButton()
        self.start_geometry_button.setIcon(QtGui.QIcon(os.path.expanduser('~/python/inputs/start.png')))
        self.start_geometry_button.setFixedWidth(30)
        self.next_geometry_button = QtWidgets.QPushButton()
        self.next_geometry_button.setIcon(QtGui.QIcon(os.path.expanduser('~/python/inputs/next.png')))
        self.next_geometry_button.setFixedWidth(30)
        self.back_geometry_button = QtWidgets.QPushButton()
        self.back_geometry_button.setIcon(QtGui.QIcon(os.path.expanduser('~/python/inputs/back.png')))
