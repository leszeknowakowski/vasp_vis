...
class MyMainWindow(MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        with open('/net/people/plgrid/plglnowakowski/python/scripts/vasp_vis_env/inputs/elementColorSchemes.json', 'r') as file:
        ...
        self.plane_height_range_slider.setRange(0, self.z)
        ...
        self.end_geometry_button.setIcon(QtGui.QIcon('/net/people/plgrid/plglnowakowski/python/scripts/vasp_vis_env/inputs/end.png'))
        self.end_geometry_button.setFixedWidth(30)
        self.start_geometry_button = QtWidgets.QPushButton()
        self.start_geometry_button.setIcon(QtGui.QIcon('/net/people/plgrid/plglnowakowski/python/scripts/vasp_vis_env/inputs/start.png'))
        self.start_geometry_button.setFixedWidth(30)
        self.next_geometry_button = QtWidgets.QPushButton()
        self.next_geometry_button.setIcon(QtGui.QIcon('/net/people/plgrid/plglnowakowski/python/scripts/vasp_vis_env/inputs/next.png'))
        self.next_geometry_button.setFixedWidth(30)
        self.back_geometry_button = QtWidgets.QPushButton()
        self.back_geometry_button.setIcon(QtGui.QIcon('/net/people/plgrid/plglnowakowski/python/scripts/vasp_vis_env/inputs/back.png'))
    ...
    def toggle_mag_above_plane(self, flag):
        ...
        if self.mag_cb.isChecked():
            slidervalue = self.plane_height_range_slider.getRange()
            height = slidervalue[0]
            end = slidervalue[1]

            coordinates = np.array(self.outcar_coordinates[self.geometry_slider.value()])
            coords = []
            magnet = []
            mag = self.outcar_data.print_magnetization()[self.geometry_slider.value()]
