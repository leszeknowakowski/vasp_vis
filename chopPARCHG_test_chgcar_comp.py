#########################################################################
# python script to reduce PARCHG points and save chopped		#
...
# run script in directory when You want all the files to be		#
# converted and input chopping factor (how many times array of points	#
# should be donwgraded) and output file type (total, spin, alfa or beta #
...
if __name__ == "__main__":
    ...
    for filename in sorted_filenames:
        ...
        if filename.startswith("PARCHG") or filename.startswith("CHGCAR"):
            tic = time.time()
